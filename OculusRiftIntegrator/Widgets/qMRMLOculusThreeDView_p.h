...
#ifndef __qMRMLOculusThreeDView_p_h
#define __qMRMLOculusThreeDView_p_h
...
//-----------------------------------------------------------------------------
class qMRMLOculusThreeDViewPrivate: public QObject
{
  Q_OBJECT
  QVTK_OBJECT
  Q_DECLARE_PUBLIC(qMRMLOculusThreeDView);
protected:
  qMRMLOculusThreeDView* const q_ptr;
public:
  qMRMLOculusThreeDViewPrivate(qMRMLOculusThreeDView& object);
  ~qMRMLOculusThreeDViewPrivate();
