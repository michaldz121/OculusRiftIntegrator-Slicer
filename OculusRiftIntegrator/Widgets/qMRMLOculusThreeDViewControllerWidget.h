...
#ifndef __qMRMLOculusThreeDViewControllerWidget_h
#define __qMRMLOculusThreeDViewControllerWidget_h
...
class Q_SLICER_MODULE_OCULUSRIFTINTEGRATOR_WIDGETS_EXPORT qMRMLOculusThreeDViewControllerWidget
...
public:
  ...
  /// Constructors
  explicit qMRMLOculusThreeDViewControllerWidget(QWidget* parent = 0);
  virtual ~qMRMLOculusThreeDViewControllerWidget();
...
public slots:
  void setThreeDView(qMRMLOculusThreeDView* threeDView);
...
private:
  Q_DECLARE_PRIVATE(qMRMLOculusThreeDViewControllerWidget);
  Q_DISABLE_COPY(qMRMLOculusThreeDViewControllerWidget);
};
